        ...
        <div class="container">
            ...
            <div class="row newsFila">
                ...
                <div class="newsCellRight well well-sm blog-post">
                    ...
                    <div class="newsCajaTexto">
                        <p>En un nuevo libro, documental y sitio web promocional, el paleontólogo Jorn Hurum, líder del equipo responsable del análisis del fósil de 47 millones de años de antigüedad mostrado en la imagen superior, sugiere que Ida es una especie crucial de nexo, un eslabón perdido en la evolución de los primates (guía interactiva de la evolución humana de la revista National Geographic).</p> 
                    </div>
                </div>
            </div>
            <div class="row newsFila">
                <div class="newsCellLeft well well-sm blog-post">
                    ...
                    <div class="newsCajaTexto">
                        <p>Barcelona será amiga de los vegetarianos y veganos. El Ayuntamiento aprobó en marzo una propuesta de ERC en la comisión de economía para declarar a la ciudad amiga de este colectivo.</p>
                        <p>La instancia implica que el Consistorio se suscriba a la campaña Lunes sin carne, que promoverá que voluntariamente ese día de la semana la alimentación que provenga de la administración local sea voluntariamente vegetariana. </p>
                    </div>
                </div>
                <div class="newsCellRight well well-sm blog-post">
                    ...
                    <div class="newsCajaTexto">
                        <p>Como cuando una madre deja por primera vez a su hijo en el colegio se sintió Sandra Correa, la gerente del Bioparque Ukumarí.</p>
                        <p>Con un llanto incontrolable, ella despidió a Zimbabue, el elefante consentido del cerrado zoológico Matecaña, que a esta hora sale de Pereira rumbo al Parque Temático Hacienda Nápoles, en Puerto Triunfo (Antioquia).</p>
                    </div> 
                </div>
            </div>
            <div class="row newsFila">
                <div class="newsCellLeft well well-sm blog-post">
                    ...
                    <div class="newsCajaTexto">
                        <p>Descubierto el motivo por el cual los flamencos se ven tan bonitos en rosa:estas aves se «maquillan» para atraer a sus parejas durante el cortejo, según explica un nuevo estudio.</p>     
                    </div>
                </div>
                <div class="newsCellRight well well-sm blog-post">
                    ...
                    <div class="newsCajaTexto">
                        <p>PANAMÁ, PANAMÁ (20/ABR/2016).- Un grupo de siete dientes fósiles, con 21 millones de años de antigüedad, pertenecientes al primer mono de América del Norte, fueron hallados en las excavaciones para la ampliación del Canal de Panamá, revelaron hoy fuentes científicas.</p>
                    </div>
                </div>
            </div>
            <!-- PAGINACION -->
            <nav>
                <div class="newsPagination text-center">
                    <ul class="pagination">
                        <li>
